...
def options(ctx):
    ...
    grp.add_option("--enable-apple-remote",  action="store_true",    default=Auto,   help="enable Apple Remote input (Mac OS X only) [autodetect]")
    grp.add_option("--enable-apple-ir",      action="store_true",    default=Auto,   help="enable Apple IR Remote input (Linux only) [autodetect]")
    ...
    grp.add_option("--enable-macosx-finder", action="store_true",    default=False,  help="enable Mac OS X Finder invocation parameter parsing [disabled]")
